        ...
        <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-2xl font-black text-gray-900 mb-4">
              Hơn 5 năm đồng hành cùng công trình Việt
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Thành lập năm 2020, Tiến Phát bắt đầu từ một cửa hàng nhỏ tại Quận 9, TP.HCM với mong muốn mang đến những vật liệu xây dựng chất lượng cao với giá cả hợp lý nhất cho người dân thành phố.
              </p>
              <p>
                Qua hơn 5 năm phát triển, chúng tôi đã trở thành một trong những đơn vị cung cấp vật liệu xây dựng và trang trí nội thất uy tín tại TP.HCM, với hơn 5.000 khách hàng tin tưởng và hàng trăm công trình lớn nhỏ.
              </p>
              <p>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { value: '5+', label: 'Năm kinh nghiệm', bg: 'bg-brand-600' },
      ...
      <section className="py-14 bg-gray-50">
        <div className="container mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500">Những cam kết chúng tôi giữ vững suốt hơn 5 năm qua</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Truck, title: 'Giao hàng tận nơi', desc: 'Đội xe chuyên dụng, giao hàng đúng hẹn.' },
              { icon: Users, title: 'Tư vấn chuyên nghiệp', desc: 'Nhân viên giàu kinh nghiệm, tư vấn phù hợp với từng công trình.' },
