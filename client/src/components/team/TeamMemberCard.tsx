  ...
  return (
    <article className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1"><p className="truncate font-bold text-gray-900">{member.name}</p><p className="text-xs text-gray-400">@{member.username}</p></div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
        ...
        <Info label="Trạng thái" value={active ? 'Hoạt động' : 'Không hoạt động'} />
